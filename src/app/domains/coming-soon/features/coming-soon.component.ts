      ...
      <mat-card class="flex flex-row">
        <div class="flex w-full max-w-md flex-col p-8 sm:p-12">
          ...
          >
            ...
            <!-- Form footer -->
            <div class="mt-8 text-md text-neutral-500">
            ...
            <div class="mt-12 flex items-center">
              <div class="flex shrink-0 items-center -space-x-1.5">
                <img
                  ...
                  src="/assets/images/photos/female-18.jpg"
                  alt="Avatar image"
                />
                <img
                  class="h-10 w-10 rounded-full object-cover ring-1"
                  src="/assets/images/photos/female-11.jpg"
                  alt="Avatar image"
                />
                <img
                  class="h-10 w-10 rounded-full object-cover ring-1"
                  src="/assets/images/photos/male-09.jpg"
                  alt="Avatar image"
                />
                <img
                  class="h-10 w-10 rounded-full object-cover ring-1"
                  src="/assets/images/photos/male-16.jpg"
                  alt="Avatar image"
                />
              </div>

          ...
          @for (note of notes; track note.id) {
            ...
            >
              ...
              >
                @if (note.labels && note.labels.length > 0) {
                  <div class="flex flex-wrap items-center gap-2">
                    @for (label of note.labels; track label) {
                      <div
                        class="rounded-lg bg-neutral-100 px-2 py-1 text-sm font-medium text-neutral-500 dark:bg-black/20"
                      >
                        {{ label }}
                      </div>
                    }
                ...
                <div
                  class="text-sm font-medium whitespace-nowrap text-neutral-500"
                >
